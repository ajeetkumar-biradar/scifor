...
teacher_chocolates = 327
num_students = 78

remaining_chocolates = teacher_chocolates % num_students

print("Remaining chocolates with the teacher after distributing to students:", remaining_chocolates)